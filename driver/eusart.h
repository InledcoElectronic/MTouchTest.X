...
#define TXSTA_BRGL          (0<<TXSTA_BRGH_SHIFT)
...
#define RCSTA_RX8           (0<<RCSTA_RX9_SHIFT)
...
#define BAUDCON_SCKP_INVERT     (1<<BAUDCON_SCKP_SHIFT)
#define BAUDCON_SCKP_NONINVERT  (0<<BAUDCON_SCKP_SHIFT)
...
#define BAUDRATE_16M_115200     34
    ...
    extern void EUSART_SetReceiveInterruptHandler(EUSART_ReceiveInterruptHandler_t handler);
